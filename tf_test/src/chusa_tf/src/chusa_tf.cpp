...
void msgCallback_pose(const geometry_msgs::PoseWithCovarianceStamped pose_in){
    ...
    position_x = pose_in.pose.position.x;
    position_y = pose_in.pose.position.y;
    position_z = pose_in.pose.position.z;

    orientation_x = pose_in.pose.orientation.x;
    orientation_y = pose_in.pose.orientation.y;
    orientation_z = pose_in.pose.orientation.z;
    orientation_w = pose_in.pose.orientation.w;
